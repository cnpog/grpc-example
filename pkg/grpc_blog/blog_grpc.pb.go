...
type BlogClient interface {
	CreateBlogPost(ctx context.Context, in *BlogPostRequest, opts ...grpc.CallOption) (*BlogPostResponse, error)
}
...
func (c *blogClient) CreateBlogPost(ctx context.Context, in *BlogPostRequest, opts ...grpc.CallOption) (*BlogPostResponse, error) {
	out := new(BlogPostResponse)
	err := c.cc.Invoke(ctx, "/server.Blog/CreateBlogPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServer interface {
	CreateBlogPost(context.Context, *BlogPostRequest) (*BlogPostResponse, error)
...
func (UnimplementedBlogServer) CreateBlogPost(context.Context, *BlogPostRequest) (*BlogPostResponse, error) {
...
func _Blog_CreateBlogPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlogPostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServer).CreateBlogPost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/server.Blog/CreateBlogPost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServer).CreateBlogPost(ctx, req.(*BlogPostRequest))
	}
...
var Blog_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.Blog",
	HandlerType: (*BlogServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateBlogPost",
			Handler:    _Blog_CreateBlogPost_Handler,
		},
	},
